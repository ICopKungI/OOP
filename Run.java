...
//    ควบคุมการเคลื่อนที่ของวัตถุหน้าจอเกม / กำหนดค่าเริ่มต้น
    private void tick() {
        ...
        for (int i = 0; i < monsterArray.size(); i++) {
            ...
            int mx2 = monsterArray.get(i).getX();
            int my2 = monsterArray.get(i).getY();
//            if ((((y - 10) < my) && (my < (y + 10))) && (((x - 10) < mx) && (mx < (x + 10)))) { //ชนที่แท้ทรู by Boy 345
//                System.out.println("Boom!!!!");
//                stop();
//            }
//            if ((((y - 10) < my2) && (my2 < (y + 10))) && (((x - 10) < mx2) && (mx2 < (x + 10)))) { //ชนที่แท้ทรู by Boy 345
//                System.out.println("Boom!!!!");
//                stop();
//            }
        }
        countp++;
        countm++;
        if (countp > 200000) { //แถม ทำให้ Player ไม่เกินขอบหน้าจอ by Boy 345
            if (right && x < 70) {
                x++;
            }
            if (left && x > 0) {
...
//
    ...
    class KeyInner implements KeyListener {
        ...
        public void keyPressed(KeyEvent ke) {
            ...
            //หน้าจบเกม
            if (key == KeyEvent.VK_SPACE && alive == false) {
                startGame();
            }
        }
